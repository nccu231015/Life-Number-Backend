...
class LifeNumSessionStore(BaseSessionStore):
    ...
    def save_session(
        self, version: str, session_id: str, conv_session: ConversationSession
    ) -> bool:
        """
        保存生命靈數會話
    ...
    def _serialize(self, conv_session: ConversationSession) -> Dict[str, Any]:
        ...
        return {
            ...
            "karma_numbers": conv_session.karma_numbers
            if hasattr(conv_session, "karma_numbers")
            else None,
        }
    ...
    def _deserialize(self, data: Dict[str, Any]) -> ConversationSession:
        ...
        # 業力數 (Karma)
        conv_session.karma_number = data.get("karma_number")
