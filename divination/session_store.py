...
class DivinationSessionStore(BaseSessionStore):
    ...
    def save_session(self, version: str, session_id: str, div_session: DivinationSession) -> bool:
        """
        保存擲筊會話
    ...
    def load_session(self, version: str, session_id: str) -> Optional[DivinationSession]:
        """
        從 Redis 載入擲筊會話
